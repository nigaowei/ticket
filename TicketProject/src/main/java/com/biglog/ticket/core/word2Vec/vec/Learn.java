package com.biglog.ticket.core.word2Vec.vec;


import com.biglog.ticket.core.word2Vec.domain.HiddenNeuron;
import com.biglog.ticket.core.word2Vec.domain.Neuron;
import com.biglog.ticket.core.word2Vec.domain.WordNeuron;
import com.biglog.ticket.core.word2Vec.util.Haffman;
import com.biglog.ticket.core.word2Vec.util.MapCount;
...
public class Learn {
    ...
    private void cbowGram(int index, List<WordNeuron> sentence, int b) {
        ...
        List<Neuron> neurons = word.neurons;
        double[] neu1e = new double[layerSize];// 璇樊椤�?
        double[] neu1 = new double[layerSize];// 璇樊椤�?
    ...
    public void train(String inFile,String outFile) throws Exception{
        long start = System.currentTimeMillis();
        String root = this.getClass().getResource("/").getPath();
        learnFile(new File(root+inFile));
        System.out.println("use time " + (System.currentTimeMillis() - start));
        saveModel(new File(root+outFile));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String inFile = "w2c";//输入文件
        String outFile = "library_javaVector.bin";//输出文件
        learn.train(inFile,outFile);
